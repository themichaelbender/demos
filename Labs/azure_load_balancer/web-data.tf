...
# https://medium.com/@gmusumeci/-howto-bootstrapping-azure-vms-with-terraform-c8fdaa457836#:~:text=+How+to+Bootstrapping+Linux+%26+Windows+Azure,the+Network%0AIn+this+step%2C+we+will...+More+
